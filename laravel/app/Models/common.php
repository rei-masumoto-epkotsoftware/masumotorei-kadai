...
public static function displayError()
{
	...
	print'<a href="../shop/member_login">戻る</a>';
	exit();
	
}

public static function gengo($seireki)
{
...
public static function pulldown_year()
{
...
public static function pulldown_month()
{
...
public static function pulldown_day()
{
